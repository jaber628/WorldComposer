...
class DrawerEnvCfg(DirectRLEnvCfg):
    ...
    # robot (Using WarmStudio coordinates, matching Tableware)
    ...
    # Cameras (Matching Tableware/Microwave exactly)
    ...
    # Drawer Base Config (Used as template for pool)
    drawer: ArticulationCfg = ArticulationCfg(
        prim_path="/World/Object/drawer",
        spawn=sim_utils.UsdFileCfg(
            usd_path=os.getcwd() + "/Assets/objects/drawer/44817/mobility.usd",
            ...
            scale=(0.26, 0.26, 0.26),  # Using the smaller scale as requested
        ),
